<template>
  <div class="app-container">
    <el-form :model="clerk" ref="clerk" :rules="rule" label-width="120px">
      ...
      <el-form-item prop="name" label="职工名称">
        <el-col :span="4">
      ...
      <el-form-item label="职工照片">
        ...
        <el-button
          type="primary"
          class="iconfont icon-r-paper" style="font-size: 16px;"
      ...
      <el-form-item>
        <el-button
          ...
          type="primary"
          class="iconfont icon-r-add" style="font-size: 16px;"
          @click="saveOrUpdate('clerk')"
          > 保存</el-button
        >
        <el-button @click="resetForm('clerk')" class="iconfont icon-r-setting" style="font-size: 16px;"> 重置</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
