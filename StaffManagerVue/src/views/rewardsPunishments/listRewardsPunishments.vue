<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-button
        type="primary"
        class="iconfont icon-r-find" style="font-size: 16px;"
        @click="getRewardsPunishmentsListPage()"
        >查询</el-button
      >
      <el-button type="default" class="iconfont icon-r-delete" style="font-size: 16px;" @click="resetData()">清空</el-button>
    </el-form>
    <el-table
      :data="list"
    ...
    >
      ...
      <el-table-column label="操作" width="210" align="center" fixed="right">
        <template slot-scope="scope">
          ...
          >
            <el-button type="primary" class="iconfont icon-r-edit" style="font-size: 16px;"
              >修改</el-button
            >
          </router-link>
          <el-button
            type="danger"
            class="iconfont icon-r-delete" style="font-size: 16px;"
